...
const TYPE_CONFIG: Record<DoctorType, { emoji: string; label: string; bg: string; border: string; textColor: string }> = {
  ...
  other: { emoji: '📞', label: 'Kontakt', bg: '#fdf6f0', border: '#e8d0d0', textColor: '#6b4a4a' },
}
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start flex-1">
        ...
        <span style={{ fontSize: '1.4rem', fontWeight: 900, color: '#2d1a1a', marginTop: '2px' }}>
          {doctor.name}
        </span>
  ...
  return (
    <div className="screen">
      ...
      <div className="scroll-zone" style={{ padding: '12px 16px', paddingBottom: 'calc(env(safe-area-inset-bottom) + 16px)', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div className="rounded-2xl px-4 py-3 mt-2" style={{ backgroundColor: '#f8e8e8', border: '2px solid #e8d0d0' }}>
          <p style={{ fontSize: '0.95rem', color: '#6b4a4a', margin: 0, textAlign: 'center', lineHeight: 1.5 }}>
